<div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
    ...
    <!-- Modal body -->
    <form id="formRoleManagement" action="{{ route('role-managements.update', $role->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="p-4 md:p-5 space-y-4 flex flex-col items-center justify-center">
            ...
            <div>
                ...
                <ul
                    class="w-full py-2 px-5 grid grid-cols-2 md:grid-cols-3 gap-4 text-sm font-medium text-gray-900 bg-gray-50 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
